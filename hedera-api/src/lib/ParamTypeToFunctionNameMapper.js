...
exports.ParamTypeToFunctionNameMapper = void 0;
...
class ParamTypeToFunctionNameMapper {
    ...
    constructor(paramType) {
        if (paramType instanceof abi_1.ParamType === false) {
    ...
    _geCanonicalTypeFor(paramType) {
        if ('int' === paramType.type)
            return 'int256';
        if ('int[]' === paramType.type)
            return 'int256[]';
        if ('uint' === paramType.type)
            return 'uint256';
        if ('uint[]' === paramType.type)
            return 'uint256[]';
...
exports.ParamTypeToFunctionNameMapper = ParamTypeToFunctionNameMapper;
//# sourceMappingURL=ParamTypeToFunctionNameMapper.js.map